...
def get_config():
    ...
    reg_group.add_argument('--drop_path', type=float, default=0, help='Stochastic depth drop path rate')
...
# uv run Cora_HRW_original.py  --data_name Cora --data_root ./data/Cora  --global_batch_size 16  --recurrent_steps 2

# uv run link_prediction_HeART_recurrence.py 
# --data_name Cora --data_root ./data/Cora 
# --global_batch_size 16 
# --recurrent_steps 2 
# --use_deepwalk_embeds True 
# --deepwalk_pkl_path /fs/pool/pool-shao/Hierarchial_RW/Plaintoid/deepwalk_embeddings_cora/Split_DW_Cora_emb_064_wl_080_cs_16_wn_16_epochs_200_sr_1.00.pickle 
# --seed 2020


# uv run link_prediction_HeART_clean.py \
#     --data_name Cora \
#     --data_root ./data/Cora \
#     --global_batch_size 16 \
#     --recurrent_steps 2 \
