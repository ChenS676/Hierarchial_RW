...
def main():
    ...
    # Final summary (overwrites any in-loop summary with the definitive best values)
    wandb.run.summary.update(
    ...
    run_csv = os.path.join(config['data_name'], f"Transformer_{config['data_name']}_LinkPred_{run_id}.csv")
    pd.DataFrame([{
    ...
    # Aggregated experiment CSV (append mode)
    exp_csv = os.path.join(config['data_name'], 'experiment_results_link_prediction_updated_final.csv')
    exp_row = {
        'seed': config['seed'], 'use_mlp': config['use_mlp'],
        'global_bs': config['global_batch_size'],
        'adam_max_lr': config['adam_max_lr'],
        'muon_min_lr': config['muon_min_lr'], 'muon_max_lr': config['muon_max_lr'],
        'mlp_lr': config['mlp_lr'],
        'walk_length': config['walk_length'], 'num_walks': config['num_walks'],
        'node2vec_p': config['node2vec_p'], 'node2vec_q': config['node2vec_q'],
        'recurrent_steps': config['recurrent_steps'],
        'mlp_num_layers': config['mlp_num_layers'], 'hidden_dim': config['hidden_dim'],
        'attn_dropout': config['attn_dropout'], 'ffn_dropout': config['ffn_dropout'],
        'resid_dropout': config['resid_dropout'], 'mlp_dropout': config['mlp_dropout'],
        'drop_path': config['drop_path'], 'neg_sample_ratio': config['neg_sample_ratio'],
...
# uv run link_prediction_HeART_clean.py  --data_name Cora --data_root ./data/Cora  --global_batch_size 16  --recurrent_steps 2


# Exp B
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 2025 &
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 2024 &
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 2026 &
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 2027 &
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 1010 &
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpB --seed 1012 &


# Exp C
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 2024
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 2025
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 2026
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 2027
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 1010
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpC --seed 1012



# Exp D
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 2024
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 2025
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 2026
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 2027
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 1010
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 16 --num_walks 16 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpD --seed 1012


# Exp A
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 2025
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 2024
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 2026
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 2027
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 1010
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 1 --walk_length 8 --num_walks 8 --global_batch_size 256 --run_tag ablation_hierarchy --exp_name ExpA --seed 1012

# Baselines
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 2025
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 2024
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 2026
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 2027
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 1010
# uv run link_prediction_HeART_clean.py --data_name Cora --data_root ./data/Cora --recurrent_steps 2  --global_batch_size 16 --run_tag ablation_hierarchy --exp_name Baseline --seed 1012
