...
# ==========================================
# WANDB HELPERS  (identical project, GIN prefix)
# ==========================================
...
def build_run_name(config: dict) -> str:
    ...
    Example: GIN_bipartite_matching_easy_h256_L6_nope_s2025
    """
...
class GINForEdgeClassification(nn.Module):
    """
    GIN-based edge classifier.
    Message passing on undirected graph (mp_edge_index); prediction uses
    original directed edge features.
    """
...
def main():
    parser = argparse.ArgumentParser(description="GIN — Bipartite Matching Edge Classification")
    ...
    # ── Optimizer — single AdamW with trapezoidal schedule ──────────────────
    ...
    with tqdm(total=total_steps, desc="Training") as pbar:
        for epoch in range(1, config["epochs"] + 1):
            ...
            for batch_idx, data in enumerate(train_loader):
                ...
                # Trapezoidal LR applied to AdamW
